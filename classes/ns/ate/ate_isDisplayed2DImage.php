...
class ATE_isDisplayed2DImage extends Interface_node
{
var $name = 'empty';
var $type = 'isDisplayed2DImage';
var $namespace = 'http://www.auster-gmbh.de/2010/08/anttree-lib';
private $mycount = 0;
...
{
return new ATE_isDisplayed2DImage();
}
