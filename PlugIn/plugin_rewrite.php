...
var $tag;
var $test = false;
var $numbformat = array();


	function Rewrite(){}
	
	function numberformat($name, $numlength)
	{
		$this->numbformat[name] = $numlength;
	...
	public function decription(){return "no description avaiable!";}
	public function get_col($col_name){return $this->rst->value($col_name);}
