...
private $semantic_uri = array();
	...
	function JSEngine(/* System.Content */ &$back, /* System.CurRef */ &$treepos)
	{
 ...
 $namespace.clazz = $funct JSEngine (){
 	...
 	this.onDoLoad = $funct(obj) /*start function */
 	{
 	...
 	//this.ajaxConnection.setMode('ONTOLOGY_STRUCTUR'); /* select mode */
 	//this.ajaxConnection.load(); /* requests structur */

 	//alert(this.ajaxConnection.xmltree);
...
/*		
  ...
  */
		...
		if($add_url)
		{
			...
			$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => $add_url), $posintree );
			$this->back->parent_node();
		}
		
		}
  
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/modifications.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/overview.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/anttree.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/SVG.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/OWL-Service.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/pedl.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/xlink.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/owl.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/rdf.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/XML-Schema.js'), $posintree );		
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/semantic_elements.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/SPARQL.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/graphic_elements.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/jsControlStructur.js'), $posintree );
$this->back->parent_node();
$this->back->create_Ns_Node('script', null, array('type' => 'text/ecmascript', 'xlink:href' => 'script/funct_lib.js'), $posintree );
