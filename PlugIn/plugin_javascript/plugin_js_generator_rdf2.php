...
require_once("/usr/share/webapps/qPortal/PlugIn/plugin_interface.php");
...
private $script_link = 'xlink:href';
	...
	*/
	public function &iter()
		...
		/*
		id : noch unklar vermutlich das Objekt, an dem angebaut wird
		*/
...
//document.getElementsByName('svg')[0].onload = de.auster_gmbh.accesselement.onDoLoad();
	...
	public function build_script()
	{
		...
		if(!$this->back->change_URI($this->uri) )return "// uri \"" . $this->uri . "\" (set_loading_tag) is invalid\n";		
...
$this->back->create_Ns_Node('script', null, array('type' => $this->type_script, $this->script_link => 'script/JSEngine.js'), $posintree );
$this->back->parent_node();
...
$this->back->create_Ns_Node('script', null, array('type' => $this->type_script, $this->script_link => 'script/funct_lib.js'), $posintree );
		...
		$attrib['http://www.w3.org/1999/xhtml#id'] = $this->tag_id;
