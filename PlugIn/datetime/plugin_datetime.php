...
//echo "$arg1, $arg2\n";
		$date = DateTimeImmutable::createFromFormat(trim($arg1), trim($arg2));

		if(!$date)throw new ErrorException(DateTimeImmutable::getLastErrors()['warnings']);
	...
	*/
	...
	if($this->rst)
	{
	  ...
	  {		//TODO has to throw an exception
	  	  if($this->source === '')throw new RuntimeException("Source is missing");;
